package com.tether.portailDalerte.util;
...
public class JwtUtil {
    // Il s'agit de la clé secrète utilisée pour signer et vérifier les JWT. Cette
    // clé est encodée en base64.
    // Elle est utilisée dans le processus de validation pour s'assurer que les
    // tokens n'ont pas été altérés.
    ...
    // Elle utilise la méthode de la bibliothèque JJWT (Java JWT) pour parsing et
    // valider le token
